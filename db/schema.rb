...
ActiveRecord::Schema.define(version: 20201110000111) do
  ...
  add_index "ips", ["address"], name: "index_ips_on_address", using: :btree
  ...
  add_index "logins", ["device_id"], name: "index_logins_on_device_id", using: :btree
